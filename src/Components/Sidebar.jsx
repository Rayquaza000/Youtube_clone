...
const Sidebar = ({hamburger,user,signedIn}) => {
  ...
  {
    bigMenu='absolute flex flex-col bg-white w-[250px] h-[calc(100vh-80px)] md:flex md:flex-col px-2.5 overflow-y-auto overflow-x-hidden';
    smallMenu='hidden';
  }
  else{
    bigMenu='absolute flex flex-col bg-white w-[250px] h-[calc(100vh-80px)] md:static md:flex md:flex-col px-2.5 overflow-y-auto overflow-x-hidden';
    smallMenu='hidden md:flex md:flex-col bg-white';
  }
