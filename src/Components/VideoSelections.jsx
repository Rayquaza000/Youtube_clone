...
function VideoSelections({alignment,videoID,title,thumbnailURL,channelName,channelProfilePicture,views,daysAgo}) {
    ...
    {
        return (
            <div className='flex flex-col w-[90%] xs:w-[50%] h-fit sm:w-[50%] md:w-[350px] md:h-fit px-2 mr-auto hover:bg-gray-300 rounded-[10px] pt-2' onClick={()=>openVideo()}>
                ...
                <div className='flex flex-row my-2'>
                    ...
                    <PiDotsThreeVerticalBold className='w-[20px] h-[20px] self-start ml-auto'/>
                </div>
                <div>
        ...
        return (
            <div className={currentPath.slice(0,20)=="/currentplayingvideo"?'flex flex-row w-[90%] h-fit md:h-fit px-4 mb-1 hover:bg-gray-300 py-2 rounded-[10px]':'flex flex-row w-[90%] h-fit md:h-fit mb-1 hover:bg-gray-300 py-2 rounded-[10px]'} onClick={()=>openVideo()}>
                ...
                <div className='flex flex-row mx-2 w-fit h-fit'>
                    ...
                    <PiDotsThreeVerticalBold className='w-[20px] h-[20px] min-w-[20px] self-start ml-auto' onClick={(e)=>{e.stopPropagation()}}/>
                </div>
                <div>
