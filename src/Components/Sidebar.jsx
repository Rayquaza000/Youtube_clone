...
const Sidebar = ({ hamburger, user, signedIn }) => {
  ...
  if (currentPath.slice(0, 20) == "/currentplayingvideo") {
    bigMenu = 'z-10 absolute flex flex-col bg-white w-[250px] h-[calc(100vh-80px)] md:flex md:flex-col px-2.5 overflow-y-auto overflow-x-hidden';
    smallMenu = 'hidden';
  }
  else {
    bigMenu = 'z-10 absolute flex flex-col bg-white w-[250px] h-[calc(100vh-80px)] md:static md:flex md:flex-col px-2.5 overflow-y-auto overflow-x-hidden';
    smallMenu = 'z-10 hidden md:flex md:flex-col bg-white';
  }
